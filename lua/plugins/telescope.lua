return {
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>q", builtin.quickfix, { desc = "[S]earch [F]iles" })
			vim.keymap.set("n", "<leader>f", builtin.find_files, { desc = "[S]earch [F]iles" })
			vim.keymap.set("n", "<leader>g", builtin.git_files, { desc = "[S]earch [F]iles" })
			...
			vim.keymap.set("n", "<leader>c", builtin.grep_string, { desc = "[S]earch current [W]ord" })
